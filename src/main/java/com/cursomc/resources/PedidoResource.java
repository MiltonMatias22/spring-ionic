...
public class PedidoResource {
	...
	@PostMapping
	public ResponseEntity<Void> insert(@Valid @RequestBody Pedido pedidoPost){
		Pedido pedido = this.pedidoService.inserir(pedidoPost);
	...
	public ResponseEntity<Page<Pedido>> findPage(
		...
		Page<Pedido> listaPedidos = this.pedidoService.buscarPagina(page, linesPerPage, ordeBy, direction);
